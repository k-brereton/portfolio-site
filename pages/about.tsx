        ...
        <div className="centering">
            <Container className={style.mainArea}>
                ...
                <div className={style.contactArea}>
                    ...
                    <Row><RiPhoneFill size={ICON_SIZE} className={style.aboutContactIcon}/> 403 <span className="hidden"> plz no spam</span>- 400 <span className="hidden"> plz</span> - 0901 </Row>
                    <Row><HiOutlineMail size={ICON_SIZE} className={style.aboutContactIcon}/> kevin<span className="hidden"> kldas;jfa</span>.brereton1<span className="hidden"> daaasc</span>@gmail<span className="hidden"> .ca</span>.com </Row>
                </div>
            </Container>
        </div>
    </>
