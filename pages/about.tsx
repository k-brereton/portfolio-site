...
export default function About() {
    return <>
        {/*MODIFICATION AREA*/}
        <PageHead description={"Kevin Brereton is a freshly graduated developer, who previously worked with the National Bank of Canada. Learn more..."} title={"Kevin Brereton | About"}/>
        ...
        <Container>
            <div className="centering">
                <motion.div layout className="about_mainArea" variants={OUTER_VARIANT}>
                    ...
                    <motion.p className="about_textArea" variants={FAST_DISAPPEARING_VARIANT}>
                        {/*MODIFICATION AREA*/}
